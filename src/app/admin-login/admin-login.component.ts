...
export class AdminLoginComponent implements OnInit {
  ...
  Login() {
    ...
    if (this.LoginId == "admin" && this.Password == "123456") {
      ...
      // this._UserService.AdminLogin(UserObj)
      //   .subscribe(
      //     _user => {
      ...
      //           this._LocalStorage.storeOnLocalStorage("FirstName", this.User[0].firstName.toString());
      //           this._LocalStorage.storeOnLocalStorage("LastName", this.User[0].lastName.toString());
      //           this._LocalStorage.storeOnLocalStorage("LoggedInBranchId", this.User[0].branchId.toString());
      //           this._LocalStorage.storeOnLocalStorage("IsPostBack", "0");
